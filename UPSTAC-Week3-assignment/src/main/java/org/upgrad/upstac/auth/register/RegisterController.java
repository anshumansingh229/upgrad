...
public class RegisterController {
    ...
    public User saveUser(@RequestBody RegisterRequest registerUserRequest) {
/*
...
*/
        ...
        try {
            return registerService.addUser(registerUserRequest);
        } catch (AppException appException) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, appException.getMessage());
        }
    }


    @RequestMapping(value = "/auth/doctor/register")
    public User saveDoctor(@RequestBody RegisterRequest registerDoctorRequest) {
/*
...
*/
        ...
        try {
            return registerService.addDoctor(registerDoctorRequest);
        } catch (AppException appException) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, appException.getMessage());
        }
    }
    ...
    public User saveTester(@RequestBody RegisterRequest registerTesterRequest) {
/*
...
*/
        ...
        try {
            return registerService.addTester(registerTesterRequest);
        } catch (AppException appException) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, appException.getMessage());
        }
    }
